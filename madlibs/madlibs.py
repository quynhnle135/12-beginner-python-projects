...
if choice == "Yes":
    ...
    madlib_one = f"It was {food} day at school, and {name} was super {adjective} for lunch. But when she went outside to eat, " \
                 f"a {noun} stole her {food}! {name} chased the {noun} all over school. She {verb_four}, {verb_five}, and {verb_six} " \
                 f"through the playground. Then she tripped on her {noun} and the {noun} escaped! Luckily, " \
                 f"{name}’s friends were willing to share their {food} with her."
    print(madlib_one)
else:
    print("Good bye!")